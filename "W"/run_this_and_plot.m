clear all;close all
x_0=[0 0 0, 0 0 0, 0 0 -pi/3, 0 0 0]'; %  specify your initial conditon
m=3;
g=9.81;
...
for i=1:n                                 % pay attention
  ...
  p_nib(i,:)=Rbn*[0 0 -l/0.8]'+pn_all(i,:)';  % l(L) by 0.8
end
...
for i=1:3800:3801                % pay attention
...
for i=1:5:dataNum
    ...
    plot3(p_nib(i,1),p_nib(i,2),p_nib(i,3),'k.')
    pause(0.03); % pause is inaccurate. pause (0.01) does not work. pause(0.1) is acceptable. In the future I may use a timer
